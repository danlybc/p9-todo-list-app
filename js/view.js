...
(function (window) {
  ...
  function View(template) {
    ...
    this.$toggleAllLabel = qs('[for="toggle-all"]');
  ...
  View.prototype.bind = function (event, handler) {
    ...
    if (event === "newTodo") {
      ...
      $on(self.$toggleAllLabel, "click", function () {
        self.$toggleAll.checked = !self.$toggleAll.checked;
        handler({ completed: self.$toggleAll.checked });
      });
